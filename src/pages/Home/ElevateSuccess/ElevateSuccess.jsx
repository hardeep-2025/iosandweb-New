...
const elevateImg = `${process.env.REACT_APP_API_URL}/assests/images/home-new/elivate_success.gif`;
                    ...
                    <Col>
                        <div className="elevate_success_flex">
                            <div className="elevate_left_col">
                                ...
                                <Link to="/contact-us" className="btn-gradient-blue">Contact Us <FontAwesomeIcon icon={faAnglesRight} /></Link>
                            </div>
