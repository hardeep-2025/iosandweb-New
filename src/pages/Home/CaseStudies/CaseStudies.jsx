...
const maproute = `${process.env.REACT_APP_API_URL}/assests/images/home-new/case-studies/maproute.webp`;
const chatbot = `${process.env.REACT_APP_API_URL}/assests/images/home-new/case-studies/chatbot.webp`;
const xrpTrade = `${process.env.REACT_APP_API_URL}/assests/images/home-new/case-studies/xrp-trade.webp`;
const AITranslator = `${process.env.REACT_APP_API_URL}/assests/images/home-new/case-studies/AITranslator.webp`;
